...
- Todo ADR aceito (`adr-0001-hexlog-mvp.md`, `adr-0002-versionamento-definicoes.md`) é registro histórico: não reescreva o corpo para refletir mudanças futuras. Uma mudança de rumo emenda com uma seção nova (ex.: "Amendment") ou um ADR seguinte (`adr-000N-...md`), nunca reescrevendo Decision/Consequences já registrados.
